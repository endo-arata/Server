...
| 5 | 入口 | Discord Bot、承認 UI、IDE 連携、音声(要確認: OQ-027) | スマホ/PC/Discord から同じ AI に届き、Discord で承認できる |
| 6 | 自律 | Morning Brief、Research Scout、Repo Guardian、Media Librarian、Sentinel | 1 週間無操作でナレッジが育ち続け、異常が自動報告される |
| 7 | 拡張 | 7章のカタログ B 群、**スマートホーム(D-026 で保留分)**、画像/動画生成、ファインチューニング、評価ハーネスの自動昇格 | 新モデルが自動評価され提案が届く |
